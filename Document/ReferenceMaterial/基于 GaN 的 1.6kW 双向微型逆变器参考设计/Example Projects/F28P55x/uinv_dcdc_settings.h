...
#define uINV_DCDC_BOOST_PWM_FREQ  (239616)
...
// Boost settings
#define uINV_DCDC_BOOST_PWM_PERIOD (CLK_FREQ/(uINV_DCDC_BOOST_PWM_FREQ)) //Not used, period re-defined in uINV_DCDC.c file
...
#define uINV_DCDC_LLC_DEF_DT ((uint32_t)7)
#define uINV_DCDC_LLC_DEF_DELAY ((uint32_t)2) // 2 ticks for PWM sync

#define uINV_DCDC_SR_DEF_DT ((uint32_t)15) //125ns
#define uINV_DCDC_SR_MIN_TICKS ((uint32_t)50)
#define uINV_DCDC_SR_TRIP_DELAY_TICKS ((uint32_t)19) //158ns
