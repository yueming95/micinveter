...
// Inverse clarke transformation
    Va = v->Ubeta;
    Vb = _IQmpy(_IQ(-0.5),v->Ubeta) + _IQmpy(_IQ(0.86602540378443864676372317075294),v->Ualpha);  // 0.8660254 = sqrt(3)/2 
    Vc = _IQmpy(_IQ(-0.5),v->Ubeta) - _IQmpy(_IQ(0.86602540378443864676372317075294),v->Ualpha);  // 0.8660254 = sqrt(3)/2
...
// X,Y,Z (Va,Vb,Vc) calculations
    Va = v->Ubeta;                                                       // X = Va 
    Vb = _IQmpy(_IQ(0.5),v->Ubeta) + _IQmpy(_IQ(0.86602540378443864676372317075294),v->Ualpha);   // Y = Vb 
    Vc = _IQmpy(_IQ(0.5),v->Ubeta) - _IQmpy(_IQ(0.86602540378443864676372317075294),v->Ualpha);   // Z = Vc
