...
void InitEPwm(void)
{
   ...
   InitEPwmGpio(); //
	...
	EPwm1Regs.TBPRD=15000;   //周期寄存器5k pwm
	EPwm1Regs.TBPHS.half.TBPHS=0x0000;//计数器的起始计数位置
	EPwm1Regs.TBCTR=0x0000;  //clear counter	
	EPwm1Regs.TBCTL.bit.CTRMODE=TB_COUNT_UPDOWN;//计数模式，连续增减
	EPwm1Regs.TBCTL.bit.PHSEN=TB_DISABLE;//disable phase loading
	EPwm1Regs.TBCTL.bit.HSPCLKDIV=TB_DIV1;//分频
	EPwm1Regs.TBCTL.bit.CLKDIV=TB_DIV1;
	EPwm1Regs.TBCTL.bit.PRDLD=TB_SHADOW;
	EPwm1Regs.TBCTL.bit.SYNCOSEL=TB_CTR_ZERO;
	EPwm1Regs.CMPCTL.bit.SHDWAMODE=CC_SHADOW;//load register every zero
	//EPwm1Regs.CMPCTL.bit.SHDWBMODE=CC_SHADOW;
	EPwm1Regs.CMPCTL.bit.LOADAMODE=CC_CTR_ZERO_PRD;
	EPwm1Regs.CMPA.half.CMPA=0;//比较寄存器
	...
	EALLOW;
	EPwm1Regs.TZSEL.bit.OSHT5=1;//使能TZ5作为epwm1单次时间的触发源
	EPwm1Regs.TZCTL.bit.TZA=2;//触发时间产生时epwm1a强制为高
	EPwm1Regs.TZCTL.bit.TZB=2;//出发时间产生时epwm1b强制高
	EPwm1Regs.TZEINT.bit.OST=1;//使能TZ5中断
	EDIS;
	
	EPwm2Regs.TBPRD=15000;//set timer period
	EPwm2Regs.TBPHS.half.TBPHS=0x0000;//phase is 0
	EPwm2Regs.TBCTR=0x0000;;//clear counter
	EPwm2Regs.TBCTL.bit.CTRMODE=TB_COUNT_UPDOWN;
	EPwm2Regs.TBCTL.bit.PHSEN=TB_ENABLE; 
	EPwm2Regs.TBCTL.bit.HSPCLKDIV=TB_DIV1;  //closck ratio to sysclkout
	...
	EALLOW;
	EPwm2Regs.TZSEL.bit.OSHT5=1;//使能TZ3作为epwm1单次时间的触发源
	EPwm2Regs.TZCTL.bit.TZA=2;//触发时间产生时epwm1a强制为高
	EPwm2Regs.TZCTL.bit.TZB=2;//出发时间产生时epwm1b强制高
	EPwm2Regs.TZEINT.bit.OST=1;//使能TZ3中断
	EDIS;
	...
	EPwm3Regs.TBPRD=15000;//set timer period
	EPwm3Regs.TBPHS.half.TBPHS=0x0000;//phase is 0
	EPwm3Regs.TBCTR=0x0000;;//clear counter
	EPwm3Regs.TBCTL.bit.CTRMODE=TB_COUNT_UPDOWN;
	EPwm3Regs.TBCTL.bit.PHSEN=TB_ENABLE; 
	EPwm3Regs.TBCTL.bit.HSPCLKDIV=TB_DIV1;  //closck ratio to sysclkout
	...
	EALLOW;
	EPwm3Regs.TZSEL.bit.OSHT5=1;//使能TZ3作为epwm1单次时间的触发源
	EPwm3Regs.TZCTL.bit.TZA=2;//触发时间产生时epwm1a强制为高
	EPwm3Regs.TZCTL.bit.TZB=2;//出发时间产生时epwm1b强制高
	EPwm3Regs.TZEINT.bit.OST=1;//使能TZ3中断
	EDIS;
