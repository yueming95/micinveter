...
extern void SetSlaveValue();
extern void SpiSlaveUpdateData(void);
#if DSP28_SPIB
...
extern Uint16 ControlLoopInRAMLoadStart;
extern Uint16 ControlLoopInRAMLoadSize;
extern Uint16 ControlLoopInRAMRunStart;
