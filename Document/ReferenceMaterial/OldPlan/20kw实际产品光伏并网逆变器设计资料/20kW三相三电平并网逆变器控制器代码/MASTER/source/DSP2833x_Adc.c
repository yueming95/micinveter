...
void InitAdc(void)
{
	...
	AdcRegs.ADCCHSELSEQ1.bit.CONV00 = 0x0006;	// Convert Channel ADCINA/B0
	AdcRegs.ADCCHSELSEQ1.bit.CONV01	= 0x0007;	// Convert Channel ADCINA/B1
	...
	AdcRegs.ADCCHSELSEQ2.bit.CONV06	= 0x0000;	// Convert Channel ADCINA/B6
	AdcRegs.ADCCHSELSEQ2.bit.CONV07	= 0x0001;	// Convert Channel ADCINA/B7
//	AdcRegs.ADCCHSELSEQ1.bit.CONV00 = 0x0006;	// Convert Channel ADCINA/B0
//	AdcRegs.ADCCHSELSEQ1.bit.CONV01	= 0x0007;	// Convert Channel ADCINA/B1
	AdcRegs.ADCTRL1.all = 0x0310;// 0x0310; // 0000 0011 0001 0000
	//bit15,	0,	reserved
